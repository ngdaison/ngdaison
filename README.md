...
|---|---|---|
| **[vinoS]** | Bare-metal UEFI OS kernel and low-level systems development. | C, Assembly |
| **[catchim]** | Web applications and interactive front-end interfaces. | C++ ,TypeScript |
---
